...
appCtrls.controller("indexCtrl", ["$scope", "$timeout", function($scope,$timeout){
	$scope.onViewLoad = function(){
		var section = $("section");
		section.css({minHeight:1000});
		$timeout(function(){	
			section.animate({minHeight:400},500);
		},1000);
	}
}]);
...
appCtrls.controller("homeCtrl", ["$scope", "$rootScope", "$interval", function($scope, $rootScope, $interval){
    ...
    $interval.cancel($scope.stopSlide);
    dereg();
  });
  $scope.currentSlide = 1;
    ...
    function startSlider() {
      $scope.stopSlide = $interval(function() {
...
appCtrls.controller("blogCtrl", ["$scope","$rootScope", "$interval", function($scope,$rootScope,$interval){

	$scope.currentSlide = 1;
	$scope.counter = 3;
	$scope.articles = [
		{id:"post-01", topic: "Topic one!", date:"20.08.2015", showImg: true, showVid:false, thumb:"blogthumb-01.jpg", full:"blog-1.jpg", videoPath:"", poster:"", text:"There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text." },
		{id:"post-02", topic: "Topic two!", date:"21.08.2015", showImg: false, showVid:true, thumb:"", full:"", videoPath:"video/video-01.mp4", poster:"video/video-01.jpg", text:"All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable." },
		{id:"post-03", topic: "Topic three!", date:"22.08.2015", showImg: false, showVid:false, thumb:"", full:"", videoPath:"", poster:"", text:"Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source." }
	];
...
//Slider function details:
	...
	$scope.stop = $interval(startSlider,pause);
	var dereg = $rootScope.$on('$locationChangeSuccess', function() {
    $interval.cancel($scope.stop);
    dereg();
  });
